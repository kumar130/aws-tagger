...
def get_resource_arns_by_name(resource_name):
    ...
    :param resource_name: The name of the AWS resource (e.g., 'ec2', 's3', 'efs', 'lambda', 'ecs', 'dms').
...
if __name__ == "__main__":
    ...
    resource_name = input("Enter the AWS resource name (e.g., 'ec2', 's3', 'efs', 'lambda', 'ecs', 'dms'): ")
